...
# ╔═╡ 036a2a1a-207b-43e3-9715-1d44c7ac649e
   using DifferentialEquations, PlutoUI, Plots; plotly(size=(360,360))

# ╔═╡ beabf07c-1c66-4b13-83ab-0e2b1aa195f9
TableOfContents()

# ╔═╡ b9f69142-e5dd-11ed-28ec-8bf9445df44e
md"""
# Ordinary differential equation (ODE)
"""

# ╔═╡ 46c87fc2-305c-4a3f-a06c-04502ac04564
md"""
$\dfrac{du}{dt}=f(u, \rho, t)$
"""

# ╔═╡ c769df5e-cafd-4c72-b0b0-ebdf81c948a1
md"""
In a specific case we have
"""

# ╔═╡ f555c47f-82a7-4893-950b-0e147f36626b
md"""
$\dfrac{du}{dt}=\rho u$
"""

# ╔═╡ ebf4d4ee-797f-4e6e-8f2e-d264d9dc9d29
md"""
### Defining our function $f(u, \rho, t)$
"""

# ╔═╡ 16cf9ecb-6049-4c22-9aa0-44b9cdf9de6a
f(u, ρ, t) = ρ*u

# ╔═╡ 6fe59879-0f58-45d0-b6d0-2b338474f5cf
md"""
### Beginning balence u₀: $(@bind u₀ Slider(1.0:1000.0, 1.0, true))
"""

# ╔═╡ f9d2373a-5026-45d8-b727-83b9b981163d
md"""
### ρ = $(@bind rho TextField(default="1.0"))
"""

# ╔═╡ baff9013-e1f9-4169-ba03-b145c31bcd5b
ρ = parse(Float64, rho)

# ╔═╡ 138ef39a-59a5-46ee-8730-d25b24bced51
md"""
### t₀ = $(@bind t_begin TextField(default="0"))
"""

# ╔═╡ 41b7c186-b453-4eeb-86f6-08513702bb77
t₀ = parse(Float64, t_begin)

# ╔═╡ 647e2a03-6531-420c-adcb-8bea21c2a076
md"""
### t₁ = $(@bind t_end TextField(default="1"))
"""

# ╔═╡ fce0b625-c03e-4486-a685-be076de03cec
t₁ = parse(Float64, t_end)

# ╔═╡ 9bb3d573-8eab-41d5-b94b-ad4c83372f61
md"""
### Define ODE problem
"""

# ╔═╡ 8474f945-7547-45f8-8540-91f4e9719674
t_span = (t₀, t₁)

# ╔═╡ 7ecd75c5-5090-4509-8041-2e4f57cbe2c4
 prob = ODEProblem(f, u₀, t_span, ρ)

# ╔═╡ 64c8ff0d-00ca-48f0-ae2c-d19ec3334fdc
md"""
### Solve problem
"""

# ╔═╡ be0ef7c2-277e-482c-a85e-648f7da2a69e
sol = solve(prob)

# ╔═╡ 86248121-10b4-43d2-872c-cf853d0500ab
md"""
### Plot solution
"""

# ╔═╡ acc71d93-6c20-495a-9736-d3fee317eaac
plot(
	sol,
	legend = false
)

# ╔═╡ 09e227da-9af8-4846-b8b1-b4f445799746
md"""
### Solution for a specific value 
"""

# ╔═╡ 9c1e8d13-a6f2-493a-83d6-a211bc471c60
sol(5)
...
git-tree-sha1 = "989d6cf1d8579aafa45f2b262086d490922eaa0d"
uuid = "28b8d3ca-fb5f-59d9-8090-bfdbd6d07a71"
version = "0.72.3"

[[deps.GR_jll]]
deps = ["Artifacts", "Bzip2_jll", "Cairo_jll", "FFMPEG_jll", "Fontconfig_jll", "GLFW_jll", "JLLWrappers", "JpegTurbo_jll", "Libdl", "Libtiff_jll", "Pixman_jll", "Qt5Base_jll", "Zlib_jll", "libpng_jll"]
git-tree-sha1 = "ed69a8d447dadd4bb9143057d56b17c7413d3a5e"
